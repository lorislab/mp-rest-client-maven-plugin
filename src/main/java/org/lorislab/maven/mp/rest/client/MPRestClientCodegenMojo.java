...
package org.lorislab.maven.mp.rest.client;
...
@Mojo(name = "codegen",
        ...
        threadSafe = true)
public class MPRestClientCodegenMojo extends AbstractMojo {
     ...
     */
    @Parameter(name = "registerProviders")
    private List<String> registerProviders;

    /**
     * The list of annotations.
     */
    @Parameter(name = "registerAnnotations")
    private List<String> registerAnnotations;

    /**
     * The list of model annotations.
     */
    @Parameter(name = "registerModelAnnotations")
    private List<String> registerModelAnnotations;

    /**
     * Location of the output directory.
     */
    @Parameter(name = "output", property = "mprestclient.codegen.maven.plugin.output",
            defaultValue = "${project.build.directory}/generated-sources/mprestclient")
    private File output;
     ...
     * Jackson annotation.
     */
    @Parameter(name = "jackson", required = false, defaultValue = "true")
    private Boolean jackson;

    /**
     * Jsonb annotation.
     */
    @Parameter(name = "jsonb", required = false, defaultValue = "false")
    private Boolean jsonb;

    /**
     * Client language to generate.
     */
    @Parameter(name = "language", required = true, defaultValue = "org.lorislab.maven.mp.rest.client.codegen.MPRestClientCodegen")
    private String language;

    /**
     * Generate rest client annotation.
     */
    @Parameter(name = "generateRestClient", required = false, defaultValue = "true")
    private Boolean generateRestClient;
    ...
    /**
     * Use the @Data annotation for the model.
     */
    @Parameter(name = "lombokData", required = false, defaultValue = "true")
     ...
     * Generate euqals.
     */
    @Parameter(name = "generateEquals", required = false, defaultValue = "false")
    private Boolean generateEquals;

    /**
     * Generate toString.
     */
    @Parameter(name = "generateToString", required = false, defaultValue = "false")
     ...
     * Formatter google.
     */
    @Parameter(name = "formatterGoogle", required = false, defaultValue = "true")
    private Boolean formatterGoogle;
    ...
    public void execute() throws MojoExecutionException {
        ...
        configurator.addAdditionalProperty("registerProviders", registerProviders);
        configurator.addAdditionalProperty("registerAnnotations", registerAnnotations);
        configurator.addAdditionalProperty("registerModelAnnotations", registerModelAnnotations);
        configurator.addAdditionalProperty("groupPrefix", groupPrefix);
        configurator.addAdditionalProperty("jackson", jackson);
        configurator.addAdditionalProperty("jsonb", jsonb);
        configurator.addAdditionalProperty("dateLibrary", dateLibrary);
        configurator.addAdditionalProperty("apiSuffix", apiSuffix);

        configurator.addAdditionalProperty("generateRestClient", generateRestClient);
